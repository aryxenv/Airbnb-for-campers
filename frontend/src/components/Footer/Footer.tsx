...
export const Footer = (): JSX.Element => {
  ...
  return (
    ...
    <footer
      className="w-full bg-border py-10 px-4 pb-4 border-t-1 border-t-gray-300"
      data-model-id="67:306"
    >
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="col-span-1 md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="font-bold text-base mb-6 text-black">
                Support & Legal
              </h3>
              <ul className="space-y-2">
                <li className="text-xs text-black leading-7">
